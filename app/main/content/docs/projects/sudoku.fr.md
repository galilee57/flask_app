...
1. générer des candidats en remplissant les cases vides,
2. évaluer leur qualité grâce à une fonction de coût,
3. appliquer des mutations lorsque les combinaisons échouent.

La fonction de coût permet de mesurer :

- le nombre de conflits,
- la validité des lignes,
- la validité des colonnes,
...
Ces configurations semblent prometteuses mais empêchent l’algorithme de progresser vers la solution globale.

Le défi consiste donc à équilibrer :

| Exploration                    | Exploitation                         |
| ------------------------------ | ------------------------------------ |
| Aspect aléatoire               | Aspect déterministe                  |
| Découverte de nouvelles pistes | Conservation des meilleurs candidats |
| Diversité                      | Optimisation                         |
...
1. génération de plusieurs candidats,
2. conservation des meilleurs individus (_élitisme_),
3. croisement des meilleurs candidats,
4. introduction de génomes aléatoires afin de maintenir la diversité.
...
Le Sudoku possède une caractéristique importante :

> une seule erreur dans une case peut invalider toute la grille.
